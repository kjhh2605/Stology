...
| 도구 | 활용 내용 |
|---|---|
| Claude | 기획안 인터뷰, 요구사항 정리, 서비스 방향성 구체화 |
| OpenAI Codex | 프로젝트 문서 정리, 데모사이트 구현 보조, 작업 지침(`AGENTS.md`) 관리 |
| oh-my-codex(OMX) | 데모사이트 제작, 작업 흐름 오케스트레이션, 검증 관리 |
| HyperFrames | Stology 60초 소개 영상 구성, HTML 기반 모션/렌더링 제작 |
