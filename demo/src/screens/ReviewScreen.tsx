...
export function ReviewScreen({ onApprove, onReject }: { onApprove: () => void; onReject: () => void }) {
  return (
    <main className="review-screen">
      <Tooltip id="tip-review-screen" title="검토 화면" body="자료1에서 추출된 개념1 후보를 승인/반려하는 app-level 검토 화면입니다." requirement="StudyShell 탭이 아닌 별도 화면이며 승인 시 기존 개념1 노드의 activation/evidence만 바뀌어야 합니다.">
        <section className="panel review-panel" tabIndex={0}>
